...
from .views import index, nosotros, admin , agregar_producto, agregar_user , api, boleta,carrito_compras,historial_compras,mantenedor_bodega,mis_datos,navegacion,nosotros
...
urlpatterns = [
    ...
    path('agregar_producto', agregar_producto, name="agregar_productos"),
